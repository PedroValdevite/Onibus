...
public class TelaVendaPassagem extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jtfPoltrona = new javax.swing.JTextField();
        ...
        jtfOrigem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jtfOrigemActionPerformed(evt);
            }
        });
        ...
        jtfPoltrona.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jtfPoltronaActionPerformed(evt);
            }
        });
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addComponent(jtfOrigem, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 120, Short.MAX_VALUE)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jtfPoltrona, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jtfPoltrona, javax.swing.GroupLayout.PREFERRED_SIZE, 22, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jtfOrigemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jtfOrigemActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jtfOrigemActionPerformed
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        // TODO add your handling code here:
        String origem = jtfOrigem.getText();
        String destino = jtfCodigo.getText();
        String data = jtfData.getText();
        String poltrona = jtfPoltrona.getText();
        String nome = jtfNome.getText();
        String cpf = jtfCpf.getText();
        
        Passageiro passageiro = new Passageiro(nome, cpf, "");
        
        if(Passageiro.VerificacaoPassageiro(passageiro) && Cidade.VerificacaoCidade(origem, destino))
        {
            TelaMenu.passagens.add(new Passagem(origem,destino,data, poltrona, passageiro));
        
         JOptionPane.showMessageDialog(null,
            "Operação realizada com sucesso! Seu numero de Passagem é " + TelaMenu.IDs
        );
        //fechar o CadastrarForm
        this.dispose();
        }else{
         JOptionPane.showMessageDialog(null,
            "Passageiro ou cidade não cadastrado. Verifique os dados ou cadastre."
        );
        }
    ...
    private void btnCancelarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelarActionPerformed
        this.dispose();
        TelaVendaPassagem telaCadCid = new TelaVendaPassagem();
    ...
    private void jtfPoltronaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jtfPoltronaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jtfPoltronaActionPerformed
...
//</editor-fold>
    ...
    private javax.swing.JTextField jtfPoltrona;
